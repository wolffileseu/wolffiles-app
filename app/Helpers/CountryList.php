...
/**
 * ISO 3166-1 alpha-2 country code list for player profile country picker.
 */
class CountryList
{
    /** All ISO codes with English names, sorted alphabetically by name. */
    public static function codes(): array
    {
        return [
            ...
            'ZM' => 'Zambia', 'ZW' => 'Zimbabwe', 'AX' => 'Aland Islands',
        ];
    }
