...
class WallpaperSettings extends Page implements HasForms
{
    ...
    {
        $this->form->fill([
            'wallpaper_slideshow_enabled' => Setting::get('wallpaper_slideshow_enabled', false),
            'wallpaper_slideshow_interval' => Setting::get('wallpaper_slideshow_interval', 10),
            'wallpaper_random_per_pageload' => Setting::get('wallpaper_random_per_pageload', true),
        ]);
    }
            ...
            Forms\Components\Section::make('Slideshow Behavior')
                ...
                ->schema([
                    ...
                    Forms\Components\TextInput::make('wallpaper_slideshow_interval')
                        ...
                        ->maxValue(120)
                        ->default(10)
                        ->visible(fn (Forms\Get $get) => $get('wallpaper_slideshow_enabled')),
    ...
    public function save(): void
    {
        ...
        Setting::set('wallpaper_slideshow_enabled', $data['wallpaper_slideshow_enabled'] ? 'true' : 'false', 'boolean', 'wallpaper');
        Setting::set('wallpaper_slideshow_interval', (int) ($data['wallpaper_slideshow_interval'] ?? 10), 'integer', 'wallpaper');
        Setting::set('wallpaper_random_per_pageload', ($data['wallpaper_random_per_pageload'] ?? true) ? 'true' : 'false', 'boolean', 'wallpaper');
